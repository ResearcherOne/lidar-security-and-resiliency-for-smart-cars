...
class RplidarModule
{
	...
	public:
		...
		void startSystem();
		void grabBatchScanData(LIDAR_batch_scan_data * lidar_batch_scan_data); //Create LIDAR_DATA_STRUCTURES.h Creating my own header will let me use other LIDAR with minimal change to my code.
		void stopSystem();
		void disposeRplidar();
};
